...
const DATA_ROOT = process.env.PDF_SHOP_DATA_DIR ?? path.join(process.cwd(), 'tmp')
...
export const PAYMENT_CONFIRMATIONS_DIR = path.join(DATA_ROOT, 'payment-confirmations')
...
export const GENERATED_DOCUMENTS_DIR = path.join(DATA_ROOT, 'generated-documents')
