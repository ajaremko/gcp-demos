...
| ------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `DATA_ROOT`         | Filesystem location of document records (`created.json`, `generated.txt`, `generated.json`, `paid.json`) | `string` (path)                                              | Must point at the same storage location the rest of the system reads and writes to. Outside production, unset falls back to `/tmp/pdf-shop-data`. **In production (`NODE_ENV=production`), the process refuses to start if this is unset** — it throws immediately at startup rather than silently writing to the wrong place. |
| `PORT`              | Port the server listens on                                                                               | `number`                                                      | Defaults to `3333` if unset.                                                                                                                                                                                                                                                                                                   |
| `NODE_ENV`          | Controls log format and verbosity                                                                        | `string`                                                      | Set to `production` in production.                                                                                                                                                                                                                                                                                             |
